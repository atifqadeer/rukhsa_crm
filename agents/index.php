...
$query = "SELECT * FROM `users` where `role`='agent' ORDER BY `id` DESC";
...
function softDeleteAgentById($id, $conn) {
    ...
    $total_records_query = "SELECT COUNT(*) FROM `users` where `role`='agent' ";
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                    ...
                                    <p class="text-muted font-size-13 mb-4">
                                        View and manage your agents efficiently.
                                    </p>
                            </div>
                            <div class="col-lg-6">
